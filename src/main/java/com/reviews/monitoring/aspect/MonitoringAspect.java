package com.reviews.monitoring.aspect;
...
public class MonitoringAspect {
    ...
    public Object monitorControllerMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String metricName = "reviews.controller.duration";
        ...
        try {
            ...
            Counter.builder("reviews.controller.errors")
                   .tag("service", "reviews")
                   .tag("class",  className)
    ...
    public Object monitorServiceMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            meterRegistry.timer("reviews.service.duration",
                    "service", "reviews",
                    "class",  className,
                    "method", methodName)
